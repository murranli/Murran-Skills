...
Full model definitions and usage notes → [`references/Model%20Library.md`](./references/Model%20Library%20EN.md)
...
📄 **[references/Model%20Library%20EN.md](./references/Model%20Library%20EN.md)** — Model library appendix; recommended to append after the main prompt
